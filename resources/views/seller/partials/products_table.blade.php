	...
	<table class="table table-borderless table-theme" style="width:100%;">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-left"><a href="{{ route('seller-manage.product-manage', [$row->id]) }}" title="{{ __('Edit') }}">{{ $row->title }}</a></td>
				...
				<td class="text-center">
					<div class="btn-group action-group">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="{{ route('seller-manage.product-manage', [$row->id]) }}">{{ __('Edit') }}</a>
