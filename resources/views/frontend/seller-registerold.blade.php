					...
					<div class="register">
						...
						<form class="form" method="POST" action="{{ route('frontend.sellerRegister') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="classification" id="classification" class="form-control @error('classification') is-invalid @enderror" required>
                                    <option value="">{{ __('Select Classification') }}</option>
                                    <option value="individual" {{ old('classification') == 'individual' ? 'selected' : '' }}>Individual</option>
                                    <option value="company" {{ old('classification') == 'company' ? 'selected' : '' }}>Company</option>
                                    <option value="group" {{ old('classification') == 'group' ? 'selected' : '' }}>Group</option>
                                    <option value="association" {{ old('classification') == 'association' ? 'selected' : '' }}>Association</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input name="document_number" type="text" class="form-control @error('document_number') is-invalid @enderror" placeholder="{{ __('Enter Relevant Document Number') }}" value="{{ old('document_number') }}" required />
