...
@php
    $gtext = gtext();
    $col = (in_array($brand_variation ?? '', ['left_sidebar','right_sidebar']))
        ? 'col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4'
        : 'col-sm-12 col-md-6 col-lg-3 col-xl-3 col-xxl-3';
@endphp
            ...
            <div class="{{ $col }}">
                <div class="item-card">
                    <div class="item-image">
                        @if(($row->is_discount == 1) && ($row->old_price != '') && ($row->old_price > 0))
                            @php
                    ...
                    <div class="item-card-bottom">
                        <a data-id="{{ $row->id }}" href="javascript:void(0);" class="btn add-to-cart addtocart">
                            {{ __('Add To Cart') }}
                        </a>
