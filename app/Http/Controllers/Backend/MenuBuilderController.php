...
class MenuBuilderController extends Controller
{
    ...
    public function getMenuBuilderPageLoad($lan, $id){
        ...
        $shops_data_list = User::where('role_id', 3)
            ->select('id', 'shop_name')
            ->orderByDesc('id')
            ->paginate(10);
            $countryId=117;
            $counties_datalist=DB::table('geo_units')
...
//                ->where('level_id', $this->countyLevelId())
        ...
        return view('backend.menu-builder', compact('main_menu', 'page_datalist', 'brand_datalist', 'menulist', 'media_datalist', 'product_category_datalist', 'product_datalist', 'blog_category_datalist','shops_data_list','counties_datalist'));
    }
	...
	public function getPagePostCategoryNameSlug($menu_type, $id){
        ...
        elseif($menu_type == 'geo_unit'){

            $data = GeoUnit::where('id', $id)->first();
